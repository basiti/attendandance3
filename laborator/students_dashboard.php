        ...
        <ul class="navbar-nav ml-auto ml-md-0">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href="stud_profil.php">Modifier Profil</a>
                    <a class="dropdown-item" href="abscent_stud.php">Status</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="students_dashboard.php">
                        ...
                        <a class="nav-link" href="chart_student.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            Charts
                        </a><a class="nav-link" href="present_stud.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Present
                        </a>
                        <a class="nav-link" href="abscent_stud.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Abscent
                        </a>
                    </div>
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active"><b>Dashboard Student</b></li>
                    </ol>
                </div>

                <!-- inclu body dashboard_stud.php -->
                ...
                <br>
                <br>
                <!-- <a href="stud_status.php">status</a> -->
                <!-- fin signature -->
