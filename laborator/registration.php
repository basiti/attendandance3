    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <center>
                        <div class="card-header"><b> CONNECT YOURSELF PLEASE</b></div>
                    </center>
                    <div class="card-body">
                        <form method="POST" action="check_donnees.php" enctype="multipart/form-data" id="form">
