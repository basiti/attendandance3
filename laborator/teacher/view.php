...
<body>
    ...
    <?php
    $user_id = $_GET["id"];
    $sql = mysqli_query($conn, "select id, username, phone, email, sex, file_name, uploaded_on from users where id='$user_id'");
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>Justification <a href="view_why.php?id=<?php echo $row["id"]; ?>">modifier</a> </td>
                            </tr>
                        <?php
                        }
                        ?>
